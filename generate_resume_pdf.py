...
def build():
    ...
    story = [
        ...
        p("Meta Front-End Developer Professional Certificate", "Job"),
        p("- Professional Certificate", "Cert"),
        p("Coursework and Skills", "Job"),
        ...
        p("Meta Backend Developer", "Job"),
        p("- Meta Backend Developer Capstone Certificate", "Cert"),
