...
const Projects = () => {
    return (
        <div className="projects">
            ...
            <p className="skill-item-project"><strong>Tech Stack</strong> React <SiReact size={30}/>, Node <SiNodedotjs size={30}/>, Express <SiExpress size={30}/> & JSON <SiJson size={22}/></p>
